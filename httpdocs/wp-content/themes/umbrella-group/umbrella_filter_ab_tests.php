...
function umbrella_get_ab_test_tags(): array
{
    if (($_SERVER["REMOTE_ADDR"] == "90.189.216.196") || is_user_logged_in() ) {
        return ['umbrella_ab_test1_variant2', 'umbrella_ab_test2_variant1','umbrella_ab_test3_variant2'];
    } else {
        return ['umbrella_ab_test1_variant1', 'umbrella_ab_test2_nothing', 'umbrella_ab_test3_variant1'];
    }
}