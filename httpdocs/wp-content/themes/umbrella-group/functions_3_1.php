...
//   wp_deregister_script( 'jquery' );
//   wp_register_script( 'jquery', 'http://ajax.googleapis.com/ajax/libs/jquery/3.7.1/jquery.min.js', array(), NULL, false);
//   wp_enqueue_script( 'jquery' );
 
// }
 
// add_action('wp_enqueue_scripts', 'crea_load_scripts', 200);
...
require get_theme_file_path() . '/template-parts/shortcodes/numbers_statistics.php';
