...
class video_block
{
    ...
    public function fill_attributes()
    {
        if (isset($this->atts['link']) && isset($this->atts['header']) && isset($this->atts['duration']) && isset($this->atts['fio']) && isset($this->atts['photo']) && isset($this->atts['text'])) {
            ...
            $this->err = 'Nott enough attributes. Here is the correct shortcode: \[video_block link="https://www.youtube.com/embed/pJikk8r9Aj8" header="Заголовок" duration="5 минут" fio="<b>Тарасова Юлия Сергеевна</b>, руководитель отдела бухгалтерского обслуживания ГК Umbrella Group" photo="123"  text="test text"\]';
            return false;
        }
    }
            ...
            <div class="video-block"> 
                <div class="video-description show-for-small">
                    ...
                    <div class="video-author">
                        ...
                        <div class="fio">
                            Рассказывают $this->fio
                        </div>
                    </div>
                </div>  
                <div class="video-frame">   
                    <iframe width="100%" height="100%" loading="lazy" src="$this->link" frameBorder="0" allow="clipboard-write; autoplay" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
                </div>
