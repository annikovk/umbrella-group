...
function statick_startup_shortcode($atts){
        $html = <<<EOTHTML
         [section id='statick_startup_shortcode' class='statick_startup_shortcode'  padding="0px"]
            <div class="statick_startup_screen pd">
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="static_text">
                               <p>
                               По <a href="https://www.sberbank.com/common/img/uploaded/files/pdf/analytics/ust_bz.pdf" target="_blank">статистике Сбербанка:</a> вероятность разорения<br> предприятия особенно высока в течение первого года<br> существования и в возрасте старше 3-х лет.</p>
                               <p> 6,5% компаний закрываются за первые полгода от регистрации,<br> только 71% малых и средних предприятий живут более 3 лет. </p>
                               </div>
                               <img src="https://taxlab.ru/wp-content/uploads/Диаграмма.svg">
                            </div>

                            <div class="static_desc_mobile">
                           <div class="static_text">
                            <p>По <a href="https://www.sberbank.com/common/img/uploaded/files/pdf/analytics/ust_bz.pdf" target="_blank">статистике Сбербанка:</a><br> вероятность разорения предприятия особенно высока в течение первого года существования.<br> Только 71% малых и средних предприятий живут более 3лет. </p>
                            </div>
                            <img src="https://taxlab.ru/wp-content/uploads/Иллюстрация.jpg">
                            </div>
                            ...
                            <div class="accrodion_top_problems">
                                ...
                                <div class="b-problems">
                                    <div class="problems__item">
                                        <a href="#" class="problems__title js-problems-title ">
                                            <span class="problems__text"><span>1</span>Нехватка денег
                                ...
                                <div class="b-problems">
                                    <div class="problems__item">
                                        <a href="#" class="problems__title js-problems-title problems__active">
                                            <span class="problems__text"><span>2</span>Сложности <br>с лицензированием 
                                            <div class="problems__spoiler js-faq-rotate"><span class="problems__symbol ">↓</span></div>
                                            </span>
                                ...
                                <div class="b-problems">
                                    <div class="problems__item">
                                        <a href="#" class="problems__title js-problems-title">
                                            <span class="problems__text"><span>3</span>Нет учёта финансов
                                                <div class="problems__spoiler js-faq-rotate"><span class="problems__symbol ">↓</span></div>
                                            </span>
                                ...
                                <div class="b-problems">
                                    <div class="problems__item">
                                        <a href="#" class="problems__title js-problems-title">
                                            <span class="problems__text"><span>4</span>Неправильное<br> оформление договоров
                                            <div class="problems__spoiler js-faq-rotate"><span class="problems__symbol ">↓</span></div> 
                                            </span>
                                ...
                                <div class="b-problems">
                                    <div class="problems__item">
                                        <a href="#" class="problems__title js-problems-title">
                                            <span class="problems__text"><span>5</span>Новичок<br> в юридических вопросах
                                            <div class="problems__spoiler js-faq-rotate"><span class="problems__symbol ">↓</span></div> 
                                            </span>
