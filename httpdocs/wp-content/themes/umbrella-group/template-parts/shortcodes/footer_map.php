    ...
    public function generate_shortcode()
    {
        $html = <<<EOHTML
                ...
                <div>
                    ...
                    <a  class="contact_link" mailvalue="info.contact@gmail.com href="mailto:info.contact@gmail.com"> info.contact@gmail.com</a>
                </div>
                  <div class="main-text-common">
                       <span itemprop="addressLocality">г. Новосибирск, </span> 
                        <ul>
                            <li itemprop="streetAddress">ул. Максима Горького, д. 34</li>
