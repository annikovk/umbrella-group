...
<li class="nav-icon has-icon">
  <?php if($icon_style) { ?><div class="header-button"><?php } ?>
		<a href="tel:+73833731717"  data-pos="<?php echo flatsome_option('mobile_overlay');?>" data-bg="main-menu-overlay"  class="<?php echo get_flatsome_icon_class($icon_style, 'small'); ?>" aria-label="<?php echo __('Menu','flatsome'); ?>" aria-expanded="false">
            <?php echo get_flatsome_icon('icon-phone'); ?>
        </a>
